...
// MARK: PublicProfile
@Observable final class PublicProfile: DataPreview {
    ...
    static var preview: PublicProfile =  PublicProfile(
...
// MARK: PublicProfile as CKRecord
extension PublicProfile: CloudKitConvertible {
