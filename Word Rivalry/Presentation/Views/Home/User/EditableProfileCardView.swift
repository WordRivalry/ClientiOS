...
struct EditableProfileCardView: View {
    ...
    @Environment(MyPublicProfile.self) private var profile: MyPublicProfile
    ...
    var profileView: some View {
        HStack(alignment: .center) {
            ...
            VStack(alignment: .leading,spacing: 10) {
                playerNameView
                    .frame(width: 150)
                TitleView(title: profile.publicProfile.title)
                    .padding(.vertical)
    ...
    var playerNameView: some View {
        HStack(spacing: 20) {
            PlayerNameView(playerName: profile.publicProfile.playerName)
    ...
    var tabContentView: some View {
        @Bindable var profile = profile.publicProfile
        Group {
